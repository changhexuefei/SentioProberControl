...
class TestProbeCommandGroup(unittest.TestCase):
    ...
    def test_get_probe_xy(self):
        ...
        result = self.test_prober.probe.get_probe_xy(ProbePosition.West, XyReference.Current)
    ...
    def test_get_probe_z(self):
        ...
        result = self.test_prober.probe.get_probe_z(ProbePosition.North, ZReference.Zero)
    ...
    def test_move_probe_xy(self):
        ...
        result = self.test_prober.probe.move_probe_xy(ProbePosition.South, XyReference.Home, 3000, 4000)
    ...
    def test_move_probe_z(self):
        ...
        result = self.test_prober.probe.move_probe_z(ProbePosition.West, ZReference.Contact, 1200)
